...
public class matrica : VOID, IEnumerable, Interface_UMathNumerics, Interface_Ural_Datatype
{
    ...
    public matrica(ushort n)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            for (int j = 0; j < n; j++) this.value[i, j] = i == j ? new drobch64(1.0) : new drobch64(0.0);
        }
    ...
    public matrica(ulong n)
    {
        ...
        {
            for (long j = 0; j < (long)n; j++) this.value[i, j] = i == j ? new drobch64(1.0) : new drobch64(0.0);
        }
    ...
    public matrica(natch16 n)
    {
        ...
        {
            for (int j = 0; j < (ushort)n; j++) this.value[i, j] = i == j ? new drobch64(1.0) : new drobch64(0.0);
        }
    ...
    public matrica(natch32 n)
    {
        ...
        {
            for (int j = 0; j < (uint)n; j++) this.value[i, j] = i == j ? new drobch64(1.0) : new drobch64(0.0);
        }
    ...
    public matrica(short [,] mtx)
    {
        ...
        {
            for (int j = 0; j < (int)this.Count[0]; j++) this.value[i, j] = new drobch64(mtx[i, j]);
        }
    }
    ...
    public matrica(matrica mtx)
    {
        ...
        {
            for (ulong j = 0; j < (ulong)mtx.Count[0]; j++) this.value[i, j] = new drobch64(mtx[i, j]);
        }
    }
    ...
    public drobch64 this[ushort x, ushort y]
    {
        ...
        set
        {
            try { this.value[x, y] = value; }
            catch (InvalidCastException) { this.value[x, y] = value; }
        }
    }
    ...
    public drobch64 this[natch16 x, natch16 y]
    {
        ...
        set
        {
            try { this.value[x.value, y.value] = value; }
            catch (InvalidCastException) { this.value[(ushort)x, (ushort)y] = value; }
        }
    }
    ...
    public drobch64 this[natch16 x, natch32 y]
    {
        ...
        set
        {
            try { this.value[(uint)x, (uint)y] = value; }
            catch (InvalidCastException) { this.value[(uint)x, (uint)y] = value; }
        }
    }
    ...
    public drobch64 this[natch16 x, natch64 y]
    {
        ...
        set
        {
            try { this.value[(ulong)x, (ulong)y] = value; }
            catch (InvalidCastException) { this.value[(ulong)x, (ulong)y] = value; }
        }
    }
    ...
    public static matrica operator +(matrica l, VOID r) => l;

    public static matrica operator +(VOID l, matrica r) => r;
    ...
    public static matrica operator +(int l, matrica r) => r + l;

    public static matrica operator +(float l, matrica r) => r + l;

    public static matrica operator +(double l, matrica r) => r + l;

    public static matrica operator +(natch16 l, matrica r) => r + l;

    public static matrica operator +(natch32 l, matrica r) => r + l;

    public static matrica operator +(natch64 l, matrica r) => r + l;

    public static matrica operator +(celch16 l, matrica r) => r + l;

    public static matrica operator +(celch32 l, matrica r) => r + l;

    public static matrica operator +(celch64 l, matrica r) => r + l;

    public static matrica operator +(drobch16 l, matrica r) => r + l;

    public static matrica operator +(drobch32 l, matrica r) => r + l;

    public static matrica operator +(drobch64 l, matrica r) => r + l;
    ...
    public static matrica operator -(matrica l)
    {
        ...
        {
            for (int j = 0; j < l2.value.GetLength(1); j++) l2[(ulong)i, (ulong)j] = l2[(ulong)i, (ulong)j] * -1;
        }
    ...
    public static matrica operator /(int l, matrica r) => r.___Inverse() * l;

    public static matrica operator /(float l, matrica r) => r.___Inverse() * l;

    public static matrica operator /(double l, matrica r) => r.___Inverse() * l;

    public static matrica operator /(natch16 l, matrica r) => r.___Inverse() * l;

    public static matrica operator /(natch32 l, matrica r) => r.___Inverse() * l;

    public static matrica operator /(natch64 l, matrica r) => r.___Inverse() * l;

    public static matrica operator /(celch16 l, matrica r) => r.___Inverse() * l;

    public static matrica operator /(celch32 l, matrica r) => r.___Inverse() * l;

    public static matrica operator /(celch64 l, matrica r) => r.___Inverse() * l;

    public static matrica operator /(drobch16 l, matrica r) => r.___Inverse() * l;

    public static matrica operator /(drobch32 l, matrica r) => r.___Inverse() * l;

    public static matrica operator /(drobch64 l, matrica r) => r.___Inverse() * l;
    ...
    public static matrica operator ^(int l, matrica r) => (r * UralMathLib.Ln(l)).___Exp();

    public static matrica operator ^(float l, matrica r) => (r * UralMathLib.Ln(l)).___Exp();

    public static matrica operator ^(double l, matrica r) => (r * UralMathLib.Ln(l)).___Exp();

    public static matrica operator ^(natch16 l, matrica r) => (r * UralMathLib.Ln(l)).___Exp();

    public static matrica operator ^(natch32 l, matrica r) => (r * UralMathLib.Ln(l)).___Exp();

    public static matrica operator ^(natch64 l, matrica r) => (r * UralMathLib.Ln(l)).___Exp();

    public static matrica operator ^(celch16 l, matrica r) => (r * UralMathLib.Ln(l)).___Exp();

    public static matrica operator ^(celch32 l, matrica r) => (r * UralMathLib.Ln(l)).___Exp();

    public static matrica operator ^(celch64 l, matrica r) => (r * UralMathLib.Ln(l)).___Exp();

    public static matrica operator ^(drobch16 l, matrica r) => (r * UralMathLib.Ln(l)).___Exp();

    public static matrica operator ^(drobch32 l, matrica r) => (r * UralMathLib.Ln(l)).___Exp();

    public static matrica operator ^(drobch64 l, matrica r) => (r * UralMathLib.Ln(l)).___Exp();
    ...
    public IEnumerator GetEnumerator()
    {
        for (int i = 0; i < (int)this.Count[0]; i++)
        {
            drobch64 [] row = Enumerable.Range(0, (int)this.Count[1])
                .Select(selector: j => (drobch64)this.value[i, j])
                .ToArray();
    ...
    protected static matrica ChisloMatrica(Interface_UDrobch value, ushort scales)
    {
        ...
        for (short i = 0; i < scales; i++) mtx[new natch16(i), new natch16(i)] = (drobch64)value;
    ...
    {
        matrica mtx = new matrica(scales);
        for (int i = 0; i < scales; i++) mtx[new natch16(i), new natch16(i)] = (drobch64)value;
    ...
    {
        matrica mtx = new matrica(scales);
        for (long i = 0; i < (long)scales; i++) mtx[new natch16(i), new natch16(i)] = (drobch64)value;
    ...
    {
        matrica mtx = new matrica(scales);
        for (short i = 0; i < (short)scales; i++) mtx[new natch16(i), new natch16(i)] = (drobch64)value;
    ...
    {
        matrica mtx = new matrica(scales);
        for (int i = 0; i < (int)scales; i++) mtx[new natch16(i), new natch16(i)] = (drobch64)value;
    ...
    public matrica ___Extends(ushort scales)
    {
        ...
        {
            for (int j = 0; j < oldN; j++) result.value[i, j] = this.value[i, j];
        }

        for (ushort i = oldN; i < oldN + scales; i++)
        {
            for (ushort j = oldN; j < oldN + scales; j++) result.value[i, j] = i == j ? new drobch64(1.0) : new drobch64(0.0);
        }
    ...
    public RCI ___Equals(matrica mtx)
    {
        ...
        {
            for (ulong j = 0; j < (ulong)this.Count[1]; j++) flag *= this[i, j].___Equals(mtx[i, j]);
        }
    ...
    public RCI ___GreaterThan(matrica mtx)
    {
        ...
        for (ulong i = 0; i < (ulong)this.Count[0]; i++)
        {
            for (ulong j = 0; j < (ulong)this.Count[1]; j++) flag *= this[i, j].___GreaterThan(mtx[i, j]);
        }
    ...
    public RCI ___GreaterThan(short _value)
    {
        ...
        for (ulong i = 0; i < (ulong)eigenvalues.value.Count; i++) flag *= eigenvalues[(int)i].___GreaterThan(_value);
    ...
    public RCI ___SmallerThan(matrica mtx)
    {
        ...
        for (ulong i = 0; i < (ulong)this.Count[0]; i++)
        {
            for (ulong j = 0; j < (ulong)this.Count[1]; j++) flag *= this[i, j].___SmallerThan(mtx[i, j]);
        }
    ...
    public RCI ___SmallerThan(short _value)
    {
        RCI flag = new RCI(true);
        massiv<dynamic> eigenvalues = this.___SobZnacheniya();
        for (ulong i = 0; i < (ulong)eigenvalues.Count; i++) flag *= eigenvalues[(int)i].___SmallerThan(_value);
    ...
    public RCI ___SmallerThan(int _value)
    {
        RCI flag = new RCI(true);
        massiv<dynamic> eigenvalues = this.___SobZnacheniya();
        for (ulong i = 0; i < (ulong)eigenvalues.value.Count; i++) flag *= eigenvalues[(int)i].___SmallerThan(_value);
    ...
    public RCI ___GreaterOrEqualThan(matrica mtx)
    {
        ...
        for (ulong i = 0; i < (ulong)this.Count[0]; i++)
        {
            for (ulong j = 0; j < (ulong)this.Count[1]; j++) flag *= this[i, j].___GreaterOrEqualThan(mtx[i, j]);
        }
    ...
    public RCI ___GreaterOrEqualThan(short _value)
    {
        RCI flag = new RCI(true);
        massiv<dynamic> eigenvalues = this.___SobZnacheniya();
        for (ulong i = 0; i < (ulong)eigenvalues.value.Count; i++) flag *= eigenvalues[(int)i].___GreaterOrEqualThan(_value);
    ...
    public RCI ___SmallerOrEqualThan(matrica mtx)
    {
        ...
        for (ulong i = 0; i < (ulong)this.Count[0]; i++)
        {
            for (ulong j = 0; j < (ulong)this.Count[1]; j++) flag *= this[i, j].___SmallerOrEqualThan(mtx[i, j]);
        }
    ...
    public RCI ___SmallerOrEqualThan(short _value)
    {
        RCI flag = new RCI(true);
        massiv<dynamic> eigenvalues = this.___SobZnacheniya();
        for (ulong i = 0; i < (ulong)eigenvalues.value.Count; i++) flag *= eigenvalues[(int)i].___SmallerOrEqualThan(_value);
    ...
    public matrica ___Extends(uint scales)
    {
        ...
        matrica result = new matrica(oldN + scales);
        ...
        {
            for (uint j = oldN; j < (long)oldN + scales; j++) result.value[i, j] = i == j ? new drobch64(1.0) : new drobch64(0.0);
        }
    ...
    public matrica ___Extends(ulong scales)
    {
        ...
        {
            for (int j = 0; j < (long)oldN; j++) result.value[i, j] = this.value[i, j];
        }

        for (ulong i = oldN; i < oldN + scales; i++)
        {
            for (ulong j = oldN; j < oldN + scales; j++) result.value[i, j] = i == j ? new drobch64(1.0) : new drobch64(0.0);
        }
    ...
    public matrica ___Extends(short scales)
    {
        switch (scales)
        {
            ...
            default :
            {
                ...
                {
                    for (short j = 0; j < newN; j++) result.value[i, j] = this.value[i, j];
                }
    ...
    public matrica ___Extends(int scales)
    {
        switch (scales)
        {
            ...
            default :
            {
                ...
                {
                    for (int j = 0; j < newN; j++) result.value[i, j] = this.value[i, j];
                }
    ...
    public matrica ___Extends(long scales)
    {
        switch (scales)
        {
            ...
            default :
            {
                ...
                {
                    for (long j = 0; j < (long)newN; j++) result.value[i, j] = this.value[i, j];
                }
    ...
    public matrica ___Extends(natch16 scales) => this.___Extends((ushort)scales);

    public matrica ___Extends(natch32 scales) => this.___Extends((uint)scales);

    public matrica ___Extends(natch64 scales) => this.___Extends((ulong)scales);

    public matrica ___Extends(celch16 scales) => this.___Extends((short)scales);

    public matrica ___Extends(celch32 scales) => this.___Extends((int)scales);

    public matrica ___Extends(celch64 scales) => this.___Extends((long)scales);

    public drobch64 ___Trace()
    {
        return new drobch64(Enumerable.Range(0, this.value.GetLength(0)).Select(selector: i => this[(ulong)i, (ulong)i])
            .Sum(selector: x => (double)x));
    }
    ...
    public matrica ___AngleSplit(ushort scales, ushort x = 0, ushort y = 0)
    {
        ...
        for (ulong i = y; i < (ulong)(x + scales); i++)
        {
            for (ulong j = x; j < (ulong)(y + scales); j++)
                try { new_mtx[i - y, j - x] = this.value[i, j] as drobch64; }
    ...
    {
        matrica new_mtx = new matrica(scales);
        for (ulong i = y; i < x + scales; i++)
        {
            for (ulong j = x; j < y + scales; j++)
                try { new_mtx[i - y, j - x] = this.value[i, j] as drobch64; }
                catch (IndexOutOfRangeException err) { }
        }
    ...
    public matrica ___AngleSplit(ushort scales, natch16 x, natch16 y)
    {
        ...
        for (ulong i = (ulong)y; i < (ulong)(x + scales); i++)
        {
            for (ulong j = (ulong)x; j < (ulong)(y + scales); j++)
                try { new_mtx[i - (ulong)y, j - (ulong)x] = (drobch64)this.value[i, j]; }
                catch (IndexOutOfRangeException err) { }
        }
    ...
    public matrica ___Add(matrica _value)
    {
        ...
        {
            for (ulong j = 0; j < (ulong)new_mtx.Count[0]; j++) new_mtx[i, j] = mtx[i, j] + _value[i, j];
        }
    ...
    public matrica ___Add(massiv<drobch64> _value) //Testing needed
    {
        ...
        {
            while (mtx.Count[0] > _value.Count) _value.___Add(0);

            _val = new matrica(mtx.Count[0]);

            for (ulong i = 0; i < (ulong)_val.Count[0]; i++) _val[i, i] = _value[i];
        }
        else if (mtx.Count[0] < _value.Count)
        {
            mtx = mtx.___Extends(_value.Count - mtx.Count[0]);
            goto Start;
        }
        else
        {
        ...
        for (ulong i = 0; i < (ulong)mtx.Count[0]; i++) mtx[i, i] = mtx[i, i] + _val[i, i];

        return mtx;
    }

    public matrica ___Multiply(short _value) => MatrixToMatrica(MatricaToMatrix(this).Multiply(_value));

    public matrica ___Multiply(int _value) => MatrixToMatrica(MatricaToMatrix(this).Multiply(_value));

    public matrica ___Multiply(long _value) => MatrixToMatrica(MatricaToMatrix(this).Multiply(_value));

    public matrica ___Multiply(float _value) => MatrixToMatrica(MatricaToMatrix(this).Multiply(_value));

    public matrica ___Multiply(double _value) => MatrixToMatrica(MatricaToMatrix(this).Multiply(_value));

    public matrica ___Multiply(celch16 _value) => MatrixToMatrica(MatricaToMatrix(this).Multiply(_value.value));

    public matrica ___Multiply(celch32 _value) => MatrixToMatrica(MatricaToMatrix(this).Multiply(_value.value));

    public matrica ___Multiply(celch64 _value) => MatrixToMatrica(MatricaToMatrix(this).Multiply(_value.value));

    public matrica ___Multiply(drobch16 _value) => MatrixToMatrica(MatricaToMatrix(this).Multiply(_value.value));

    public matrica ___Multiply(drobch32 _value) => MatrixToMatrica(MatricaToMatrix(this).Multiply(_value.value));

    public matrica ___Multiply(drobch64 _value) => MatrixToMatrica(MatricaToMatrix(this).Multiply(_value.value));


    public massiv<drobch64> ___Multiply(massiv<short> _value) => NullityVectorToMatrica(this.___Multiply(MatricaToNullityVector(_value)));

    public massiv<drobch64> ___Multiply(massiv<int> _value) => NullityVectorToMatrica(this.___Multiply(MatricaToNullityVector(_value)));

    public massiv<drobch64> ___Multiply(massiv<long> _value) => NullityVectorToMatrica(this.___Multiply(MatricaToNullityVector(_value)));

    public massiv<drobch64> ___Multiply(massiv<float> _value) => NullityVectorToMatrica(this.___Multiply(MatricaToNullityVector(_value)));

    public massiv<drobch64> ___Multiply(massiv<double> _value) => NullityVectorToMatrica(this.___Multiply(MatricaToNullityVector(_value)));

    public massiv<drobch64> ___Multiply(massiv<celch16> _value) => NullityVectorToMatrica(this.___Multiply(MatricaToNullityVector(_value)));

    public massiv<drobch64> ___Multiply(massiv<celch32> _value) => NullityVectorToMatrica(this.___Multiply(MatricaToNullityVector(_value)));

    public massiv<drobch64> ___Multiply(massiv<celch64> _value) => NullityVectorToMatrica(this.___Multiply(MatricaToNullityVector(_value)));

    public massiv<drobch64> ___Multiply(massiv<drobch16> _value) => NullityVectorToMatrica(this.___Multiply(MatricaToNullityVector(_value)));

    public massiv<drobch64> ___Multiply(massiv<drobch32> _value) => NullityVectorToMatrica(this.___Multiply(MatricaToNullityVector(_value)));

    public massiv<drobch64> ___Multiply(massiv<drobch64> _value) => NullityVectorToMatrica(this.___Multiply(MatricaToNullityVector(_value)));
    ...
    public matrica ___Multiply(matrica _value)
    {
        ...
        try { return MatrixToMatrica(mtx.Multiply(val)); }
        catch (Exception err) { return _value; }
    }
    ...
    public matrica ___Pow(short _value) => MatrixToMatrica(MatricaToMatrix(this).Power(_value));

    public matrica ___Pow(int _value) => MatrixToMatrica(MatricaToMatrix(this).Power(_value));

    public matrica ___Pow(long _value) => MatrixToMatrica(MatricaToMatrix(this).Power((int)_value));

    public matrica ___Pow(float _value)
    {
        massiv<matrica> diag = this.___Diagonalisacia();
        for (ulong i = 0; i < (ulong)diag[1].Count[0]; i++) diag[1][i, i] = new drobch64(this.pow((double)diag[1][i, i], _value));
    ...
    {
        massiv<matrica> diag = this.___Diagonalisacia();
        for (ulong i = 0; i < (ulong)diag[1].Count[0]; i++) diag[1][i, i] = new drobch64(pow((double)diag[1][i, i], _value.value));
    ...
    public matrica ___Pow(matrica _value) => (_value * this.___Ln()).___Exp();
    ...
    public matrica ___Sqrt()
    {
        ...
        for (ulong i = 0; i < (ulong)eigenvalues_mtx.Count[0]; i++) eigenvalues_mtx[i, i] = UralMathLib.Sqrt(new drobch64(eigenvalues_mtx[i, i]));
    ...
    public matrica ___Cbrt()
    {
        ...
        for (ulong i = 0; i < (ulong)eigenvalues_mtx.Count[0]; i++) eigenvalues_mtx[i, i] = UralMathLib.Cbrt(new drobch64(eigenvalues_mtx[i, i]));

        return eigenvectors_mtx.___Multiply(eigenvalues_mtx).___Multiply(eigenvectors_mtx_inverse);
    }


    public matrica ___Ln() => ___MathFunc(this, UralMathLib.Ln);

    public matrica ___Lt() => ___MathFunc(this, UralMathLib.Lt);

    public matrica ___Lg() => ___MathFunc(this, UralMathLib.Lg);

    public matrica ___Sin() => ___MathFunc(this, UralMathLib.Sin);

    public matrica ___ArcSin() => ___MathFunc(this, UralMathLib.ArcSin);

    public matrica ___Cos() => ___MathFunc(this, UralMathLib.Cos);

    public matrica ___ArcCos() => ___MathFunc(this, UralMathLib.ArcCos);

    public matrica ___Sec() => ___MathFunc(this, UralMathLib.Sec);

    public matrica ___Csc() => ___MathFunc(this, UralMathLib.Csc);

    public matrica ___Sinh() => ___MathFunc(this, UralMathLib.Sinh);

    public matrica ___ArcSinh() => ___MathFunc(this, UralMathLib.ArcSinh);

    public matrica ___Cosh() => ___MathFunc(this, UralMathLib.Cosh);

    public matrica ___ArcCosh() => ___MathFunc(this, UralMathLib.ArcCosh);

    public matrica ___Tanh() => ___MathFunc(this, UralMathLib.Tanh);

    public matrica ___Exp() => ___MathFunc(this, UralMathLib.Exp);

    public natch64 ___Rank() => new natch64(MatricaToMatrix(this).Rank());
    ...
    public static matrica ___MathFunc(matrica mtx, Func<drobch64, drobch64> f)
    {
        ...
        for (ulong i = 0; i < (ulong)eigenvalues_mtx.Count[0]; i++) eigenvalues_mtx[i, i] = f(eigenvalues_mtx[i, i]);
    ...
    */
    ...
    public matrica ___Transpose() => MatrixToMatrica(MatricaToMatrix(this).Transpose());

    public massiv<dynamic> ___SobZnacheniya()
    {
        matrica eigenvalues_mtx = MatrixToMatrica(MatricaToMatrix(this).Evd().D);
        ArrayList eigenvalues = new ArrayList();
        for (ulong i = 0; i < (ulong)eigenvalues_mtx.Count[0]; i++) eigenvalues.Add(eigenvalues_mtx[i, i]);
    ...
    public static drobch64 ___HyperDotProduct(matrica mtx1, matrica mtx2) => mtx1.___Multiply(mtx2.___Transpose()).___Trace();

    public static matrica ___HyperCrossProduct(matrica mtx1, matrica mtx2) => mtx1.___Multiply(mtx2.___Transpose()).___Diagonalisacia()[0];
    ...
    public static matrica ___HyperQuaternion(spisok arr, RCI var)
    {
        ...
        matrica A = ___HyperQuaternion(new spisok(extendedArr[..mid]), var);
        ...
        Matrix<double>? top = DenseMatrix.OfMatrix(MatricaToMatrix(A)).Append(MatricaToMatrix(B));
        Matrix<double>? bottom = DenseMatrix.OfMatrix(-MatricaToMatrix(B).Transpose()).Append(MatricaToMatrix(A).Transpose());
        return MatrixToMatrica(top.Stack(bottom));
    }

    public override string ToString() => this.ToString();

    public virtual string ToString(string out_left_b = "[", string out_right_b = "]", string in_left_b = "[", string in_right_b = "]",
        string sep = ", ")
    {
    ...
    protected static Matrix<double> MatricaToMatrix(matrica mtx)
    {
        ...
        for (ulong i = 0; i < (ulong)mtx.Count[0]; i++)
        {
            for (ulong j = 0; j < (ulong)mtx.Count[1]; j++) values[i, j] = (double)new drobch64((drobch64)mtx.value[i, j]); //ToDo
        }
    ...
    protected static matrica MatrixToMatrica(Matrix<double> mtx)
    {
        ...
        {
            for (ulong j = 0; j < (ulong)mtx.ColumnCount; j++) values[i, j] = new drobch64(mtx[(int)i, (int)j]);
        }
    ...
    public static matrica MatricaToNumeric(short _value)
    {
        ...
        for (ulong i = 0; i < (ulong)mtx.Count[0]; i++) mtx[i, i] = new drobch64(_value);
    ...
    {
        matrica mtx = new matrica(2);
        for (ulong i = 0; i < (ulong)mtx.Count[0]; i++) mtx[i, i] = _value;
    ...
    {
        matrica mtx = new matrica(scales);
        for (ulong i = 0; i < (ulong)mtx.Count[0]; i++) mtx[i, i] = (drobch64)_value;
