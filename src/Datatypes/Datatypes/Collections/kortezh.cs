...
public class kortezh : VOID, IEnumerable, Interface_Ural_Datatype
{
    ...
    public static explicit operator string(kortezh _value) => _value.ToString();

    public static explicit operator str10(kortezh _value) => new str10(_value.ToString());

    public static explicit operator str16(kortezh _value) => new str16(_value.ToString());

    public static explicit operator str32(kortezh _value) => new str32(_value.ToString());

    public static explicit operator str64(kortezh _value) => new str64(_value.ToString());


    public static explicit operator kortezh(massiv<Type> _value) => new kortezh((ArrayList)_value.value);

    public static explicit operator kortezh(spisok _value) => new kortezh((ArrayList)_value.value);

    public static explicit operator kortezh(ArrayList _value) => new kortezh(ParamsValidation(_value));

    public static explicit operator ArrayList(kortezh _value) => (ArrayList)_value.value;
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new str64(_value) }; }
        else
        {
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new RCI(_value) }; }
        else
        {
            KortezhOutOfRangeError err = new KortezhOutOfRangeError(0, 0);
            err.Execute();
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new celch32(_value) }; }
        else
        {
            KortezhOutOfRangeError err = new KortezhOutOfRangeError(0, 0);
            err.Execute();
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new natch64(_value) }; }
        else
        {
            KortezhOutOfRangeError err = new KortezhOutOfRangeError(0, 0);
            err.Execute();
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new natch16(_value) }; }
        else
        {
            KortezhOutOfRangeError err = new KortezhOutOfRangeError(0, 0);
            err.Execute();
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new natch32(_value) }; }
        else
        {
            KortezhOutOfRangeError err = new KortezhOutOfRangeError(0, 0);
            err.Execute();
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new drobch64(_value) }; }
        else
        {
            KortezhOutOfRangeError err = new KortezhOutOfRangeError(0, 0);
            err.Execute();
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new celch16(_value.value) }; }
        else
        {
            KortezhOutOfRangeError err = new KortezhOutOfRangeError(0, 0);
            err.Execute();
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new celch32(_value.value) }; }
        else
        {
            KortezhOutOfRangeError err = new KortezhOutOfRangeError(0, 0);
            err.Execute();
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new celch64(_value.value) }; }
        else
        {
            KortezhOutOfRangeError err = new KortezhOutOfRangeError(0, 0);
            err.Execute();
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new drobch16(_value.value) }; }
        else
        {
            KortezhOutOfRangeError err = new KortezhOutOfRangeError(0, 0);
            err.Execute();
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new drobch32(_value.value) }; }
        else
        {
            KortezhOutOfRangeError err = new KortezhOutOfRangeError(0, 0);
            err.Execute();
    ...
    {
        if (this.Count.value <= this.MaxLength) { this.value = new ArrayList { new drobch64(_value.value) }; }
        else
        {
            KortezhOutOfRangeError err = new KortezhOutOfRangeError(0, 0);
            err.Execute();
    ...
    public kortezh(List<uint> _value) : base(_value)
    {
        ...
        else { this.value = new KortezhOutOfRangeError(0, 0); }
    }
    ...
    public kortezh this[int start, natch16 stop, natch16 step] =>
        new kortezh(Slice(this.value.ToArray(), start, (int)stop.value, (int)step.value));
    ...
    public kortezh this[natch16 start, int stop, natch16 step] =>
        new kortezh(Slice(this.value.ToArray(), (int)start.value, stop, (int)step.value));
    ...
    public kortezh this[natch16 start, natch16 stop, int step] =>
        new kortezh(Slice(this.value.ToArray(), (int)start.value, (int)stop.value, step));

    public kortezh this[natch16 start, natch16 stop, natch16 step] =>
        new kortezh(Slice(this.value.ToArray(), (int)start.value, (int)stop.value, (int)step.value));
